...
fun create(){
    ...
    print("Ingrese las horas laborables (Double): ")
    ...
    while (opcion){
        ...
        print("\tIngrese el número de alumnos registrados (Int): ");
        ...
        print("\tIngrese las horas de duración semanales (Double): ");
        var horasImpartidasAsignatura : Double = javaReader.readLine().toDouble()
        print("\tIngrese el aula (Char): ");
        var aulaAsignatura : Char = javaReader.readLine().get(0)
        print("\t¿La asignatura es vespertina? (Boolean): ");
        ...
        print("\t¿Desea ingresar una nueva asignatura para el respectivo Maestro? (S/N)")
        opcion=javaReader.readLine().toUpperCase()=="S"
    }
        ...
        2 -> {
            ...
            if (JSONProfesores.any {it.materiasImpartidas==idSearch}){
                ...
                while (optionUpdateAsignatura){
                    ...
                    print("\t¿Desea actualizar más informacoón? (S/N): ")
